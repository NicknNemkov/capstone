...
This dataset will be used for its salary numbers column. 
...
2. Is there a noticable trend between a person's salary and their sex? What about their race? Several visuals will be implemented. First, the data will be divided into male and female dataframes. The average salary will be calculated for males and female, this will be plotted on a bar graph. As for race, similar steps will be taken to create a bar graph (data divided by race and averages calculated).
